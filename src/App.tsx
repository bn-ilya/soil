    ...
    return (
        <div className={styles.wrapper}>
            ...
            <div className={styles.inputWrapper}>
                <Text variant="header-2">К кому Иисус говорит притчу?</Text>
                <TextArea
                    size="xl"
            ...
            <div className={styles.inputWrapper}>
                <Text variant="header-2">Куда сеятель сеит свои семена?</Text>
                <TextArea
                    size="xl"
            ...
            <div className={styles.inputWrapper}>
                <Text variant="header-2">Куда упало первое семя?</Text>
                <TextArea
                    size="xl"
            ...
            <div className={styles.inputWrapper}>
                <Text variant="header-2">Что с ним случилось?</Text>
                <TextArea
                    size="xl"
            ...
            <div className={styles.inputWrapper}>
                <Text variant="header-2">Как по вашему какая основная прблематика этой почвы?</Text>
                <TextArea
                    size="xl"
            ...
            <div className={styles.inputWrapper}>
                <Text variant="header-2">Какой результат принесло бы сохраненое семя?</Text>
                <TextArea
                    size="xl"
            ...
            <div className={styles.inputWrapper}>
                <Text variant="header-2">Куда упало второе семя?</Text>
                <TextArea
                    size="xl"
            ...
            <div className={styles.inputWrapper}>
                <Text variant="header-2">Как эта почва принимает Слово?</Text>
                <TextArea
                    size="xl"
            ...
            <div className={styles.inputWrapper}>
                <Text variant="header-2">Куда упало третье семя?</Text>
                <TextArea
                    size="xl"
            ...
            <div className={styles.inputWrapper}>
                <Text variant="header-2">Что выросло на этой почве?</Text>
                <TextArea
                    size="xl"
            ...
            <div className={styles.inputWrapper}>
                <Text variant="header-2">Что является "терновник" в толковании Иисуса?</Text>
                <TextArea
                    size="xl"
                    value={values.question15 || ''}
            ...
            <div className={styles.inputWrapper}>
                <Text variant="header-2">Если бы семя сохранилось какой был бы результат?</Text>
                <TextArea
                    size="xl"
            ...
            <div className={styles.inputWrapper}>
                <Text variant="header-2">Куда упало четвертое семя?</Text>
                <TextArea
                    size="xl"
            ...
            <div className={styles.inputWrapper}>
                <Text variant="header-2">Что на этой почве делают со Словом</Text>
                <TextArea
                    size="xl"
            ...
            <div className={styles.inputWrapper}>
                <Text variant="header-2">Какой результат приносит эта почва?</Text>
                <TextArea
                    size="xl"
            ...
            <div className={styles.inputWrapper}>
                <Text variant="header-2">На какой из почв были слушающие?</Text>
                <TextArea
                    size="xl"
